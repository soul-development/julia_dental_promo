{/* <script> */}
        ...
        const translations = {
            ...
            ru: {
                // Hero section
                heroTitle: '🦷 СЧАСТЛИВАЯ УЛЫБКА СЕГОДНЯ: Бюджетное стоматологическое страхование!',
...
Я буду рада помочь вам вернуть здоровую, счастливую улыбку — с двумя проверенными планами, которые я лично использую и рекомендую, и с местными стоматологами, которых вы уже знаете и которым доверяете.`,
                ...
                metlifeCoverage: [
                    ...
                    "✅ 50% – Крупный процедуры (импланты, коронки, каналы, мосты, протезы, хирургия"
                ],
                ...
                deltaCoverage: [
                    ...
                    "✅ 50% – Крупный процедуры (Импланты, коронки, мосты, хирургия, протезы)"
                ],
                deltaPricing: [
                    "$55 – Индивидуально",
                    "$100 – Взрослый + дети",
