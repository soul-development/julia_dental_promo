{/* <script> */}
        ...
        const translations = {
            en: {
                ...
                clientStats: `👉 Dental care in the U.S. is notoriously expensive. Sadly, many people delay essential checkups and treatments simply because they can’t afford them — only to face more serious dental problems later that may cost a fortune to fix.
                <br><br>
                ...
                <br><br>
                To my surprise, the implant was covered at 50%, and within just a few months, I saved nearly $2,000. That experience sparked a mission for me — a passionate and caring insurance broker — to help others unlock the same kind of smart, money-saving coverage.
                Because everyone deserves a healthy, beautiful smile. 😃
                <br><br>
                Since then, over 1,000 clients and their families nationwide have used these plans to save thousands on cleanings, fillings, crowns, root canals — and yes, implants. Even local dentists in New York City, Philadelphia, and San Francisco, skeptical at first, became my strongest advocates — now referring hundreds of patients each year to get covered.
                <br><br>
                Now it’s your turn!
                I’d be thrilled to help you restore your healthy, happy smile — with two trusted plans I personally use and recommend, and local dental professionals you already know and trust.`,
                ...
                metlifeCoverage: [
                    ...
                    "✅ 80% – Fillings, extractions, gum treatment",
                    "✅ 50% – Implants, crowns, root canals, bridges, dentures, oral surgery"
                ],
                monthlyPremiums: "💰 Monthly Premiums for an Individual (sample rates based on ZIP code, includes $5 association membership*):",
                metlifePricing: [
                ...
                deltaCoverage: [
                    "✅ 100% – Preventive",
                    "✅ 80% – Fillings, extractions, root canals",
                    "✅ 50% – Implants, crowns, bridges, surgery, dentures"
                ],
                deltaPricing: [
                    "$55 – Individual",
                    "$100 – Adult + Children",
                ...
                coverageExplanation: [
                    "📌 The 100%, 80%, and 50% coverage is calculated based on the in-network negotiated rate for each dental procedure.",
            ...
            ru: {
                ...
                juliaPassion: "Мне также нравится находить инновационные решения, которые закрывают важнейшие пробелы и помогают реально экономить на жизненно необходимых услугах — например, на стоматологическом лечении.",
                clientStats: `👉 Стоматологические услуги в США достаточно дорогие. К сожалению, многие откладывают необходимые осмотры и лечение просто потому, что не могут себе этого позволить, — и в итоге сталкиваются с более серьезными проблемами, исправление которых может стоить целое состояние.
<br><br>
Большинство индивидуальных стоматологических страховых планов — если они не предлагаются через работодателя — имеют длительные периоды ожидания для серьезных процедур, таких как коронки и лечение корневых каналов, и почти никогда не покрывают импланты.
<br><br>
Около трех лет назад, пытаясь сэкономить на собственном импланте (стоимость которого оценивалась почти в $5,000), коллега из сферы медицинского страхования познакомил меня со скрытой жемчужиной: групповые планы MetLife PPO и Delta Dental PPO с отсутствием периодов ожидания и исключений по отсутствующим зубам — даже для таких серьезных процедур, как импланты и коронки.
<br><br>
К моему удивлению, имплант был покрыт на 50%, и всего за несколько месяцев я сэкономила почти $2,000. Этот опыт вдохновил меня — увлеченного и заботливого страхового брокера — на миссию помогать другим открывать для себя такое же умное и выгодное покрытие.
Потому что каждый заслуживает здоровую, красивую улыбку. 😃
<br><br>
С тех пор более 1,000 клиентов и их семей по всей стране воспользовались этими планами, чтобы сэкономить тысячи на чистках, пломбах, коронках, лечении корневых каналов — и да, на имплантах. Даже местные стоматологи в Нью-Йорке, Филадельфии и Сан-Франциско, поначалу настроенные скептично, стали моими самыми сильными сторонниками — теперь они направляют сотни пациентов в год, чтобы те получили страховку.
<br><br>
Теперь ваша очередь!
Я буду рада помочь вам вернуть здоровую, счастливую улыбку — с двумя проверенными планами, которые я лично использую и рекомендую, и с местными стоматологами, которых вы уже знаете и которым доверяете.`,
                ...
                metlifeCoverage: [
                    ...
                    "✅ 80% – Пломбы, удаление, лечение дёсен",
                    "✅ 50% – Импланты, коронки, каналы, мосты, протезы, хирургия"
                ],
                monthlyPremiums: "💰 Примерные ежемесячные стоимости, в зависимости от ZIP-кода (включая $5 членский взнос):",
                metlifePricing: [
                ...
                juliaRecommendationMetlife: "РЕКОМЕНДАЦИЯ ЮЛИИ: Подходит тем, кому нужно серьёзное стоматологическое лечение или у кого врач работает только с сетью MetLife.",
                ...
                deltaCoverage: [
                    "✅ 100% – Профилактика",
                    "✅ 80% – Пломбы, удаление, лечение каналов",
                    "✅ 50% – Импланты, коронки, мосты, хирургия, протезы"
                ],
                deltaPricing: [
                    "$55 – Индивидуально",
                    "$100 – Взрослый + дети",
                ...
                juliaRecommendationDelta: "РЕКОМЕНДАЦИЯ ЮЛИИ: Надёжный и доступный план для всей семьи. Поможет сохранить здоровье зубов по минимальной цене.",
                ...
                // Partners section
                partnersTitle: "Наши проверенные стратегические партнеры",
            },
            uk: {
                // Hero section
                ...
                juliaPassion: "Я допомагаю людям захистити себе, свої сім'ї та бізнес від руйнівних фінансових ризиків — чи то через серйозні захворювання, втрату доходу, потребу в довготривалому догляді або втрату близької людини — освічуючи їх та створюючи розумні, індивідуальні страхові стратегії. Мені також подобається знаходити інноваційні рішення, які заповнюють критичні прогалини та дозволяють реально заощаджувати на життєво важливих послугах, таких як стоматологічний догляд.",
                clientStats: `👉 Стоматологічне лікування у США відомо як дуже дороге. На жаль, багато людей відкладають необхідні огляди та лікування просто тому, що не можуть собі цього дозволити, — і зрештою стикаються з набагато серйознішими проблемами, виправлення яких може коштувати цілий статок.
                <br><br>
                Більшість індивідуальних стоматологічних страхових планів — якщо вони не пропонуються через роботодавця — мають тривалі періоди очікування для серйозних процедур, таких як коронки та лікування кореневих каналів, і майже ніколи не покривають імпланти.
                <br><br>
                Близько трьох років тому, коли я намагалася заощадити на встановленні імпланту (вартість якого оцінювалась майже в $5,000), колега зі сфери медичного страхування познайомив мене з вигідним варіантом, про який мало хто знав: групові плани MetLife PPO та Delta Dental PPO без періодів очікування та без виключень щодо відсутніх зубів — навіть для таких серйозних процедур, як імпланти та коронки.
                <br><br>
                На мій подив, імплант було покрито на 50%, і всього за кілька місяців я заощадила майже $2,000. Цей досвід надихнув мене — відданого своїй справі та турботливого страхового брокера — на місію допомагати іншим відкривати для себе таке ж розумне та вигідне покриття.  
                Тому що кожен заслуговує на здорову, красиву посмішку. 😃
                <br><br>
                З того часу понад 1,000 клієнтів та їхніх сімей по всій країні скористалися цими планами, щоб заощадити тисячі на чищеннях, пломбах, коронках, лікуванні кореневих каналів — і так, на імплантах. Навіть місцеві стоматологи в Нью-Йорку, Філадельфії та Сан-Франциско, які спочатку були налаштовані скептично, стали моїми найсильнішими прихильниками — тепер вони направляють сотні пацієнтів щороку, щоб ті отримали страхування.
                <br><br>
                Тепер — ваша черга!  
                Я буду рада допомогти вам повернути здорову, щасливу посмішку — з двома перевіреними планами, які я особисто використовую та рекомендую, та з місцевими стоматологами, яких ви вже знаєте і яким довіряєте.
                `,
                ...
                metlifeCoverage: [
                    ...
                    "✅ 80% – Пломби, видалення, лікування ясен",
                    "✅ 50% – Імпланти, коронки, лікування каналів, мости, протези, оральна хірургія"
                ],
                monthlyPremiums: "💰 Щомісячні внески для окремої особи (приблизні тарифи в залежності від ZIP-коду, включаючи $5 членський внесок*):",
                metlifePricing: [
                ...
                juliaRecommendationMetlife: "РЕКОМЕНДАЦІЯ ЮЛІЇ: Найкраще для тих, хто потребує серйозної стоматологічної роботи (імпланти, коронки, обширне лікування) або чий лікар працює в мережі лише з MetLife (заощадить вам більше грошей)",
                ...
                deltaCoverage: [
                    "✅ 100% – Профілактика",
                    "✅ 80% – Пломби, видалення, лікування каналів",
                    "✅ 50% – Імпланти, коронки, мости, хірургія, протези"
                ],
                deltaPricing: [
                ...
                juliaRecommendationDelta: "РЕКОМЕНДАЦІЯ ЮЛІЇ: Надійний, бюджетний план. Чудовий для сімей. Підтримає здоров'я ваших зубів з мінімальними щомісячними витратами.",
                
                // How coverage works
                coverageWorksTitle: "💡 Як працюють відсотки покриття",
                coverageExplanation: [
                    "📌 100%, 80% та 50% покриття розраховується на основі узгодженого тарифу в мережі для кожної стоматологічної процедури.",
                ...
                afterEnrollmentDetails: [
                    "Зазвичай ви з'являтесь у системі страховика між 8 та 15 числом першого місяця",
                ...
                // Partners section
                partnersTitle: "Наші стратегічні партнери",
            }
        };
